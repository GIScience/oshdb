...
import static org.heigit.bigspatialdata.oshdb.api.utils.export.JSONTransformerTest.LONLAT_A;
import static org.heigit.bigspatialdata.oshdb.api.utils.export.JSONTransformerTest.TAGS_A;
import static org.heigit.bigspatialdata.oshdb.api.utils.export.JSONTransformerTest.USER_A;
...
public class OSHDbGeometryBuilderTest {
  ...
  public void testGetGeometryClipped_4args_1() {
    ...
    Geometry result = OSHDbGeometryBuilder.getGeometryClipped(entity, timestamp, areaDecider, clipBbox);
    assertEquals(expResult, result);
  }
  ...
  public void testGetGeometryClipped_4args_2() {
    ...
    Geometry expResult = (new GeometryFactory()).createPoint(new Coordinate(100, 80));
    Geometry result = OSHDbGeometryBuilder.getGeometryClipped(entity, timestamp, areaDecider, clipPoly);
    assertEquals(expResult, result);
  }
