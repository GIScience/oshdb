...
[![Build Status](http://jenkins.ohsome.org/buildStatus/icon?job=oshdb/master)](http://jenkins.ohsome.org/blue/organizations/jenkins/oshdb/activity/?branch=master)
