...
public class HOSMWay extends HOSMEntity<OSMWay> implements Serializable {
	...
	public static HOSMWay instance(final byte[] data, final int offset, final int length) throws IOException {
		return instance(data, offset, length, 0, 0, 0, 0);
	}

	public static HOSMWay instance(final byte[] data, final int offset, final int length, final long baseId,
		...
		return new HOSMWay(data, offset, length, baseId, baseTimestamp, baseLongitude, baseLatitude, header, id, bbox,
				keys, dataOffset, dataLength, nodeIndex, nodeDataOffset, nodeDataLength);
	}

	private HOSMWay(final byte[] data, final int offset, final int length, final long baseId, final long baseTimestamp,
	...
	@Override
	public HOSMWay rebase(long baseId, long baseTimestamp, long baseLongitude, long baseLatitude) throws IOException {
	...
	public static HOSMWay build(List<OSMWay> versions, Collection<HOSMNode> nodes) throws IOException {
