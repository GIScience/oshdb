...
import org.heigit.bigspatialdata.hosmdb.osh.HOSM;
...
public class TestHOSMCellRelation {
  ...
  public void test() throws IOException {
    ...
    HOSMRelation relation300 = HOSMRelation.build(Arrays.asList(//
        new OSMRelation(300, 1, 3333l, 4444l, 23, new int[] {},     new OSMMember[] {new OSMMember(100, -1, 0, 0), new OSMMember(102, -1, 0, 0)}), //
        new OSMRelation(300, 2, 3333l, 4444l, 23, new int[] {1, 2}, new OSMMember[] {new OSMMember(100, -1, 0, 0), new OSMMember(102, -1, 0, 0)})), //
        Arrays.asList(node100, node102), Arrays.asList());
    
    HOSMRelation relation301 = HOSMRelation.build(Arrays.asList(//
        new OSMRelation(301, 1, 3333l, 4444l, 23, new int[] {},     new OSMMember[] {new OSMMember(200, -1, 1, 0), new OSMMember(202, -1, 1, 0)}), //
        new OSMRelation(301, 2, 3333l, 4444l, 23, new int[] {1, 2}, new OSMMember[] {new OSMMember(200, -1, 1, 0), new OSMMember(202, -1, 1, 0)})), //
    ...
    hosmCell.forEach(osh -> {
      try {
        System.out.printf("%d (%s) %d\n",osh.getId(), print((List<HOSMEntity>)(List)osh.getNodes()), osh.getWays().size());
