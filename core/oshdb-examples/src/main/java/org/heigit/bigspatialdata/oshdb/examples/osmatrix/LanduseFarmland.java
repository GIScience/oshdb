...
public class LanduseFarmland extends Attribute {

	private static final Logger logger = Logger.getLogger(LanduseFarmland.class);
	
	Set<String> values = new HashSet<String>();

	@Override
	public String getName() {
		return "landuse_farmland";
	}

	@Override
	public String getDescription() {
		return "The area covered by farmland and farm yards given in square meters.";
	}
