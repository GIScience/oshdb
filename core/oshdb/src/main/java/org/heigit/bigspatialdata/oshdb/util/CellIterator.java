...
public class CellIterator {
  ...
  public static class IterateAllEntry {
    ...
    IterateAllEntry(Long from, Long to, OSMEntity entity, OSMEntity previousOsmEntity, Geometry geom, Geometry previousGeometry, EnumSet<ContributionType> activities) {
      this.validFrom = from;
      this.validTo = to;
