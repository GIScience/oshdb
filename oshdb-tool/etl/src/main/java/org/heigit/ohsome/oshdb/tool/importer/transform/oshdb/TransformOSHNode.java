...
public class TransformOSHNode extends OSHNode2 {
  ...
  public static TransformOSHNode build(ByteArrayOutputWrapper output, ByteArrayOutputWrapper record,
      ByteArrayOutputWrapper aux, List<OSMNode> versions, final long baseId,
  ...
  public static TransformOSHNode instance(final byte[] data, final int offset, final int length,
    ...
    return new TransformOSHNode(data, offset, length, header, id, baseTimestamp, baseLongitude,
        baseLatitude, dataOffset, dataLength);
  }
  ...
  private TransformOSHNode(final byte[] data, final int offset, final int length, final byte header,
