...
public interface TagTranslator extends AutoCloseable {
     ...
     */
    OSMTagKey getOSMTagKeyOf(int key);
     ...
     * @throws OSHDBTagOrRoleNotFoundException if the given tag key cannot be found
     */
    OSMTagKey getOSMTagKeyOf(OSHDBTagKey key);
     ...
     */
    OSMTag getOSMTagOf(int key, int value);
     ...
     * @throws OSHDBTagOrRoleNotFoundException if the given role cannot be found
     */
    OSMRole getOSMRoleOf(OSHDBRole role);
}
