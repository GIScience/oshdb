...
public class GeoTest {
  ...
  public void testAreaRealLifeSmall() {
    ...
    Polygon polygon = gf.createPolygon(new Coordinate[]{
        ...
        new Coordinate(8.6707583, 49.4160821)});
    assertEquals(expectedResult, Geo.areaOf(polygon), delta);
  }

  @Test
  public void testAreaRealLifeHuge() {
    // use https://www.openstreetmap.org/relation/7579947 state 2020-10-29
    double expectedResult = 2386876807.747; // calculated with QGIS
    double delta = expectedResult * 1E-5; // max 0.001 % error
    Polygon polygon = gf.createPolygon(new Coordinate[]{
  ...
  @Test
  public void testAreaRealLifeEquator() {
    // use https://www.openstreetmap.org/relation/2793215 state 2020-10-29
    double expectedResult = 2033079184.522; // calculated with QGIS
    double delta = expectedResult * 1E-5; // max 0.001 % error
    Polygon polygon = gf.createPolygon(new Coordinate[]{
  ...
  @Test
  public void testAreaRealLifeSouthPole() {
    // use https://www.openstreetmap.org/way/226763404 state 2020-10-29
    double expectedResult = 410425.251; // calculated with QGIS
    double delta = expectedResult * 1E-5; // max 0.001 % error
    Polygon polygon = gf.createPolygon(new Coordinate[]{
